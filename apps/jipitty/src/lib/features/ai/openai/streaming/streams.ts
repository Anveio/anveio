 ...
 */
export const EventStream: OpenAIStream = (stream, { mode = "tokens" }) => {
...
export const TokenStream: OpenAIStream = (
	...
	return pipeline(EventStream(stream, options), TokenParser)
}
...
export const ChatStream: OpenAIStream = (
	...
	return pipeline(EventStream(stream, options), ChatParser)
}
