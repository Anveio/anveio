...
export type Stub = {
    ...
    connect: () => WebSocket;
    socket: (pathOrInit?: string | RequestInit, maybeInit?: RequestInit) => Promise<WebSocket>;
    fetch: (pathOrInit?: string | RequestInit, maybeInit?: RequestInit) => Promise<Response>;
};
