...
const siteUrl = process.env.NEXT_PUBLIC_SITE_URL ?? 'https://shovonhasan.com'
	...
	return (
		...
		>
			<body className="m-0 flex min-h-screen justify-center bg-slate-50 text-slate-900 [font-feature-settings:'kern','liga'] leading-[1.6] dark:bg-slate-950 dark:text-slate-200">
				<div className="flex min-h-screen w-full max-w-[88ch] flex-col px-[clamp(1.75rem,5vw,3.5rem)] py-0">
