    ...
    <article className="">
      ...
      <div className="py-12 space-y-12">
        <section className="space-y-6">
          ...
          <p>
            You can of course use any database you like but Planetscale is the
        ...
        <section className="space-y-6">
          ...
          <p>
            ...
            used in that example, including Drizzle ORM and Planetscale to get
            10 million free events a month, read on.
          </p>
          <p>
            If you're adding analytics to a project using this exact tech stack
            already I expect it'll take just a few minutes to get this set up.
            If you're starting a project fresh, this entire tutorial will likely
        ...
        <section className="space-y-6">
          ...
          <ol className="list-decimal">
            ...
            <li>
              A lil' frontend app that pings this edge function from the user's
              browser.
            </li>
          </ol>
          <p className="py-3">
        ...
        <section className="space-y-6">
          ...
          <p>
            ...
            development. You can use it alongside npm when Bun has some gap in
            feature parity.
          </p>
          <p>
          ...
          <p>
            It also helps to have the Vercel CLI to manage environment variables
        ...
        <section className="space-y-6">
          ...
          <div className="space-y-3">
            ...
            <p>
              @vercel/edge includes the utilities to pull the ip and geolocation
              from requests.
            </p>
            <p>
              drizzle-kit wil let us perform migrations and push migrations to
              the connected database
            </p>
            <p>
              drizzle-orm will allow us to write typesafe queries and take some
              boilerpalte out of the picture. It compiles down to SQL so there's
              no runtime cost to using it.
            </p>
            <p>
            ...
            <p>
              @planetscale/database exports a function that allows drizzle to
              create a connection to the Planetscale database, it's a set and
              forget config thing.
            </p>
          </div>
          <div className="py-6">
        ...
        <section className="space-y-6">
          ...
          <p>
            Then, from the overview tab, click connect on the top right and then
            "new password" on the top right of the modal that pops up. This will
            give you a connection string that includes the username, password,
            branch, and URL of the database. It's the only credential we need to
            connect to the DB from our app. Do this once for the "main" branch
            and once for the "dev" branch and make sure to copy the DATABASE_URL
          ...
          <p>
            ...
            pushing to Github...) Navigate to the Environment Variables section
            in your Vercel project's settings, Uncheck "Preview" and
            "Development" and paste in the `DATABASE_URL="..."`environment
            variable using the credentials for the "main" branch of your
            Planetscale Database into the text fields and hit save. Do the same
            for the "dev" branch but uncheck "Production" and "Preview" before
            hitting save.
          </p>
          <p>
            Now from a terminal somewhere in your project run the following
            commands to pull in the development environment variables into your
            local filesystem.
          </p>
          <Codeblock
            language="shell"
          ...
          />
          <p>
            Next, we'll start writing some code. First make files we'll put our
            core DB code in.
          </p>
          <Codeblock
            language="shell"
          ...
          />
          <p>
            In src/lib/db/db.ts we'll put the core code to initialize our DB and
          ...
          />
          <p>
            In the above codeblock we make sure we have DATABASE_URL set, and
            ensure it throws at build time if it's not. We also set up logging
            while in development mode but you can disable that entirely or even
            enable it in production. We export default a config that's read by
            Drizzle Kit so that it knows where to find our schemas to generate
            migrations and push DB changes.
          </p>
          ...
          <p>
            ...
            useful column as it seems redundant with the country column, but I
            include it for exhaustiveness. Feel free to remove it for your
            project.
          </p>
          <p>
            The API for our analytics event is that events have an "event_type"
            and "metadata". We can enforce the presence or lack of metadata for
            some events as the API layer and get some type-safety at build time
            with TypeScript.
          </p>
          <p>
            Feel free to play around with the character lengths of these
            columns. I'm using 50 for the event_type column as I plan to stuff
            as much information into a structured event_type string as possible,
            but if you prefer a different approach you can get away with a
            smaller character allocation.
          </p>
        </section>
      </div>
