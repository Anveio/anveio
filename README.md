...
5. When you need to recreate the admin account, open the Convex dashboard and run the action `dev.seedAdmin`. It pulls from `ADMIN_EMAIL` / `ADMIN_PASSWORD`, enforces the admin role, and syncs any existing sessions.
